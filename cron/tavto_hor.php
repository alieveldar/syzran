...
.prokazan_table td {vertical-align:top;} .prokazan_table .vertical td {padding-bottom: 10px;}</style></head><body><table class="prokazan_table"><tr>';
